...
int main (){
	...
	nodo->sx=1;
	nodo->dx=2;
	nodo->conta=0; //conta il numero della domanda per sapere se è arrivato a 20;
	nodo->foglia=0;//if 0 nodo, if 1 foglia
	nodo->pieno=0;//if 0 vuoto, if 1 pieno
...
void fine_partita(struct tree *nodo, struct salvataggio *salva){
		...
		//while(getchar() != '\n');
			...
			if (scelta_menu[0]=='1'){//scelta 1 nuova partita
			  	system("cls");
			  	analisi_nodo(nodo, salva, 0);}
			else if (scelta_menu[0]=='2'){//scelta 2 menu
				system("cls");
				menu_principale(nodo,salva);}
			else if (scelta_menu[0]=='3'){//scelta 3 esci
				system("cls");
				sequenza_di_chiusura();}
			else {system("cls");
				printf ("__________________________________________\n\nErrore 001: comando immesso non valido.\n__________________________________________\n");
	...
	gets(scelta_menu);
			...
			//while(getchar() != '\n');
				...
				if (scelta_menu[0]=='1'){
					system("cls");
					analisi_nodo(nodo, salva, 0);}
				else if (scelta_menu[0]=='2'){
					system("cls");
					carica_salvataggio(salva, nodo);}
				else if (scelta_menu[0]=='3'){
					system("cls");
					elimina_salvataggio(salva, nodo);}
				else if (scelta_menu[0]=='4'){
					system("cls");
					schermata_di_spiegazione(nodo, salva, 1, -500);}
				else if (scelta_menu[0]=='5'){
					system("cls");
					sequenza_di_chiusura();}
				else {
					system("cls");
